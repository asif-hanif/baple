...
assert workdir.endswith('digestpath'), f"Please make sure this script is in main 'digestpath' dataset directory and run it from the 'digestpath' directory. Current working directory is: {workdir}"
...
if __name__=='__main__':
    ...
    step_1_resultdir = opj(dd, 'processed',
                            ...
                            (cropsize, crop_overlap, non_bg_threshold, '_'.join(str(x) for x in downsample_list)),
                            'step_1'
                        )
